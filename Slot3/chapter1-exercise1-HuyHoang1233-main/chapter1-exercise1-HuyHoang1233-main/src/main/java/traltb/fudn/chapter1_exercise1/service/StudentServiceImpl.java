 ...
 *
 *  CHECKLIST:
 *    [x] create(Student)         - validate (requireId=false) + repo.save
 *    [x] getById(Long)           - validate id > 0 + repo.findById
 *    [x] getAll()                - return repo.findAll
 *    [x] update(Student)         - validate (requireId=true) + repo.update
 *    [x] deleteById(Long)        - validate id > 0 + repo.deleteById
 *    [x] validateStudent(...)    - validation logic chi tiết bên dưới
 *
 *  CÁC RULE VALIDATION:
