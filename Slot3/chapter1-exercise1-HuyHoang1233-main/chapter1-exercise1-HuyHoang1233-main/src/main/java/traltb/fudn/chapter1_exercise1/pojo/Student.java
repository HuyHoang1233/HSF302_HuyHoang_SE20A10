 ...
 *    [x] Map class với bảng "students" qua @Table
 *    [x] Khai báo các field: id, email, password, firstName, lastName, marks
 *    [x] Đánh dấu id là @Id + @GeneratedValue(strategy = GenerationType.AUTO)
 *    [x] Đánh dấu các @Column với name, nullable, unique phù hợp
 *    [x] Khai báo Set<Book> books với @OneToMany + @JoinColumn
 *    [x] Generate constructor (no-arg + all-arg) và getter/setter
