 ...
 *
 *  CHECKLIST:
 *    [x] save(Student)     - gọi DAO.save(), return student
 *    [x] findById(Long)    - gọi DAO.findById(), wrap = Optional.ofNullable()
 *    [x] findAll()         - gọi DAO.findAll()
 *    [x] update(Student)   - gọi DAO.update(), return student
 *    [x] deleteById(Long)  - gọi DAO.delete()
 *
