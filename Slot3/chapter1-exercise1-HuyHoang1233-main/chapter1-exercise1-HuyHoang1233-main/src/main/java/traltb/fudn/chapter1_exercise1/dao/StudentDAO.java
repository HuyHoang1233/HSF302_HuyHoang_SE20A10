 ...
 *
 *  CHECKLIST:
 *    [x] save(Student)     - persist entity, commit transaction
 *    [x] findById(Long)    - tìm theo id, return null nếu không thấy
 *    [x] findAll()         - JPQL "SELECT s FROM Student s"
 *    [x] update(Student)   - find + update các field + commit
 *    [x] delete(Long)      - find + remove + commit
 *
 *  LƯU Ý QUAN TRỌNG:
